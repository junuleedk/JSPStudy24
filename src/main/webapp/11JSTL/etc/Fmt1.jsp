...
<body>
    ...
    <!-- 
    groupingUsed : 세자리마다 콤마를 출력한다. true가 디폴트이므로 콤마를 출력하지 않는다면 false로 지정해야한다.
     -->
    ...
    <!-- 
	    ...
	    var : 이 속성이 있으면 태그가 작성된 위치에서는 바로 출력되지 않고 EL로 원하는 곳에서 출력할 수 있다. 
	    	  만약 이 속성이 없으면 태그가 있는 위치에 즉시 출력된다. 
     -->
