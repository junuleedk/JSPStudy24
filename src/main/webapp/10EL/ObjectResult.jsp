...
<body>
	...
	<!-- 
		...
		"속성명.멤버변수명" 형태로 기술하면 클레스에 선언된 getter()를 자동으로
		호출하여 값을 출력한다. 즉, 아래 문장은 getter를 호출하고 있으므로 클래스에서
		getName()을 주석처리하면 에러가 발생하게 된다. 
	 -->
	<ul>
