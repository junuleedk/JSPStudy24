    ...
    <table border="1" width="90%">
        ...
        <tr>
            ...
            <!-- 줄바꿈을 위해 Enter를 입력하면 저장시 \r\n으로 입력된다.
            	 웹브라우저에서는 <br>태그가 있어야 줄바꿈이 되므로 아래와 같이 변경해준다.
             -->
        ...
        <tr>
            ...
            <%
            /*
            로그인이 된 상태에서 세션영역에 저장된 아이디가 해당 게시물을 작성한 아이디와 일치하면 수정, 삭제 버튼을 
            보이게 처리한다. 즉, 작성자 본인에게만 수정, 삭제버튼이 보이게 된다. 
            */
