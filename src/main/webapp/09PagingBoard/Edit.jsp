...
BoardDTO dto = dao.selecView(num);
...
<!-- 
글쓰기 폼은 반드시 post방식으로 제작해야한다. get방식은 파일을 첨부할 수없고, 전송량도 4KB로
제한된다. 하지만 post는 전송량의 제한이 없고 이미지, 음원 등의 파일도 전송할 수 있기 때문이다. 
 -->
 
<!-- 중요!!
 수정페이지는 일반적으로 쓰기페이지를 복사해서 사용하게 되므로 action 속성값을 반드시 수정해야 된다. 만약 수정되지
 않으면 게시물이 추가되는 헤프닝이 생긴다. 
 -->
